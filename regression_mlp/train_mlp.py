...
def get_neural_mlp_model(input_shape, activation_func='relu'):
    """
    ...
    hidden_layer_1 = keras.layers.Dense(
        units=30, activation=activation_func)(input)
    hidden_layer_2 = keras.layers.Dense(
        units=100, activation=activation_func)(hidden_layer_1)
    hidden_layer_3 = keras.layers.Dense(
        units=30, activation=activation_func)(hidden_layer_2)
